...
if ( ! class_exists( 'Perfume_Store_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Perfume_Store_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$perfume_store_contents = wp_remote_retrieve_body( $response );

			return $perfume_store_contents;
		}
...
if ( ! function_exists( 'perfume_store_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function perfume_store_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Perfume_Store_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'perfume_store_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function perfume_store_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Perfume_Store_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
