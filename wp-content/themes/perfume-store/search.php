...
<div class="box-image">
   ...
   <div class="page-header">
      <?php echo '<h2 class="mb-0">' . esc_html__('You searched: ', 'perfume-store') . get_search_query() . '</h2>'; ?>
...
<div class="container">
   <div id="content" class="contentsecwrap">
      <?php
      $perfume_store_sidebar_layout = get_theme_mod( 'perfume_store_sidebar_post_layout','right');
      if($perfume_store_sidebar_layout == 'left'){ ?>
      <div class="row m-0">
      ...
      <?php }else if($perfume_store_sidebar_layout == 'right'){ ?>
      <div class="row m-0">
         <div class="col-lg-8 col-md-8">
            <div class="postsec-list">
               <?php if ( have_posts() ) : ?>                            
      ...
      <?php }else if($perfume_store_sidebar_layout == 'full'){ ?>
      <div class="full">
         <div class="postsec-list">
            <?php if ( have_posts() ) : ?>                            
               <?php while ( have_posts() ) : the_post(); ?>
      ...
      <?php }else if($perfume_store_sidebar_layout == 'three-column'){ ?>
      <div class="row m-0">
      ...
      <?php }else if($perfume_store_sidebar_layout == 'four-column'){ ?>
      <div class="row m-0">
         <div class="col-lg-3 col-md-3" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
      ...
      <?php }else if($perfume_store_sidebar_layout == 'grid'){ ?>
      <div class="row m-0">
